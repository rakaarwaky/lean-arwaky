...
(function () {
  ...
  var TIPS = {
    ...
    logical_sessions: 'Explicit editor session presence; unavailable when the editor does not emit open, heartbeat, and close telemetry.',
    mcp_transports: 'Live MCP transport processes. One process can serve multiple logical editor sessions.',
    ...
    agent_swimlanes: 'Live MCP transport processes, their status, PID, and last heartbeat.',
