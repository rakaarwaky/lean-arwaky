...
pub(crate) const J_PER_TOKEN: f64 = 0.4;

/// Watt-hours in a full smartphone charge — the relatable yardstick used in the UI.
pub(crate) const WH_PER_PHONE_CHARGE: f64 = 12.0;
...
#[must_use]
pub(crate) fn grid_co2_g_per_kwh() -> f64 {
...
#[must_use]
pub(crate) fn format_for_tokens(tokens_saved: u64) -> String {
...
#[must_use]
pub(crate) fn phone_charges_hint(tokens_saved: u64) -> Option<String> {
