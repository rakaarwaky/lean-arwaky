...
<details>
<summary><strong>Full feature list (82 MCP tools)</strong></summary>
...
| **MCP** | All 82 tools via MCP protocol, no shell hooks | Protocol-only agents (JetBrains, VS Code, Zed, ...) |
...
- **82 MCP tools** — from simple file reads to multi-agent orchestration
